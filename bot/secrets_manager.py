...
class SecretsManager:
    ...
    def prompt_for_token(self):
        ...
        print("📌 Lấy token tại: https://discord.com/developers/applications")
        print("="*60)
    ...
    def prompt_for_admin_password(self):
        ...
        while True:
            password = getpass.getpass("👤 Nhập mật khẩu admin (tối thiểu 6 ký tự): ").strip()
            if len(password) < 6:
    ...
    def prompt_for_web_key(self):
        ...
        print("="*60)
        print("Key này dùng để truy cập vào Web Admin")
        print("="*60)
        ...
        if choice == "1":
            ...
            print("📌 Vui lòng lưu lại key này!")
